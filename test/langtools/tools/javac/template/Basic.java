...
public class Basic {
    ...
    static void primitivesTest() {
        for (String type : new String[] {
            ...
            compPass(type + " x = 10; " + type + "  y = 20; Snippet<Snippet.PlainText> result = #\"\\{x} + \\{y} = \\{x + y}\";");
        }
    }
    ...
    static void missingPartsTest() {
        compFail("""
            int x = 10;
            Snippet<Snippet.PlainText> result = #"\\{x";
        """);
        compFail("""
            int x = 10;
            Snippet<Snippet.PlainText> result = #"\\{{x}";
        ...
        compFail("""
            int x = 10;
            Snippet<Snippet.PlainText> result = #"\\{ (x + x }";
        """);
    }
    ...
    static void expressionsTest() {
        compPass("""
            ...
            Snippet<Snippet.PlainText> result1 = #"\\{x + 1}";
            Snippet<Snippet.PlainText> result2 = #"\\{x + x}";
            Snippet<Snippet.PlainText> result3 = #"\\{x - x}";
            Snippet<Snippet.PlainText> result4 = #"\\{x * x}";
            Snippet<Snippet.PlainText> result5 = #"\\{x / x}";
            Snippet<Snippet.PlainText> result6 = #"\\{x % x}";
            Snippet<Snippet.PlainText> result7 = #"\\{x + (x + x)}";
            Snippet<Snippet.PlainText> result8 = #"\\{y[x - 9]}";
            Snippet<Snippet.PlainText> result9 = #"\\{System.out}";
            Snippet<Snippet.PlainText> result10 = #\"""
                    \\{ "a string" }
                    \""";
                    """);
        compPass("""
            Snippet<Snippet.PlainText> result = #\"""
                 \\{
    ...
    static void invalidExpressionsTest() {
        ...
        compFail("""
            int x = 10;
            Snippet<Snippet.PlainText> result = #"\\{ true ?  : x - 1 }";
        """);
        compFail("""
             String result = #"\\{ 'a }";
        """);
        compFail("""
            int x = 10;
            Snippet<Snippet.PlainText> result = #"\\{ Math.min(, x - 1) }";
        """);
        compFail("""
            int x = 10;
            Snippet<Snippet.PlainText> result = #"\\{ \\tx }";
