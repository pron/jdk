...
public class StringTemplateTest {
    ...
    String genFragments(Category c) {
        ...
        for (int i = 0; i < 1500; i++) {
            ...
            fragments.add(PlainText.join(#"test(String.format(Locale.US,#\"\{format}\\{\{value}}\"), \"\{format}\", \"\{qValue}\", \{value}, log);"));
        }
        return String.join("\n        ", fragments);
    }
    ...
    public static void main(String... args) throws Exception {
        ...
        if (!log.isEmpty()) {
            ...
            throw new AssertionError(PlainText.join(#"failed \{log.size()} tests"));
        }
    }
}
