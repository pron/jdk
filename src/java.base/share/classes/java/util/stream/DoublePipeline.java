 ...
 * @since 1.8
 */
abstract class DoublePipeline<E_IN, throws X>
        extends AbstractPipeline<E_IN, Double, X, DoubleStream<X>>
        implements DoubleStream<X> {
     ...
     */
    DoublePipeline(AbstractPipeline<?, E_IN, X, ?> upstream, int opFlags) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    final <P_IN> Node<Double> evaluateToNode(PipelineHelper<Double, X> helper,
    ...
    @Override
    final <P_IN> Spliterator<Double, X> wrap(PipelineHelper<Double, X> ph,
                                          Supplier<Spliterator<P_IN, X>> supplier,
                                          boolean isParallel) {
        return new StreamSpliterators.DoubleWrappingSpliterator<P_IN, X>(ph, supplier, isParallel);
    }

    @Override
    @SuppressWarnings("unchecked")
    final Spliterator.OfDouble<X> lazySpliterator(Supplier<? extends Spliterator<Double, X>> supplier) {
        return new StreamSpliterators.DelegatingSpliterator.OfDouble<>((Supplier<Spliterator.OfDouble<X>>) supplier);
    }
    ...
    private <U> Stream<U, X> mapToObj(DoubleFunction<? extends U> mapper, int opFlags) {
        return new ReferencePipeline.StatelessOp<Double, U, X>(this, StreamShape.DOUBLE_VALUE, opFlags) {
            @Override
    ...
    @Override
    public final PrimitiveIterator.OfDouble<X> iterator() {
        return Spliterators.iterator(spliterator());
    }

    @Override
    public final Spliterator.OfDouble<X> spliterator() {
    ...
    @Override
    public final Stream<Double, X> boxed() {
        return mapToObj(Double::valueOf, 0);
    }

    @Override
    public final DoubleStream<X> map(DoubleUnaryOperator mapper) {
    ...
    @Override
    public final <U> Stream<U, X> mapToObj(DoubleFunction<? extends U> mapper) {
        Objects.requireNonNull(mapper);
        return mapToObj(mapper, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT);
    }

    @Override
    public final IntStream<X> mapToInt(DoubleToIntFunction mapper) {
        Objects.requireNonNull(mapper);
    ...
    @Override
    public final LongStream<X> mapToLong(DoubleToLongFunction mapper) {
        Objects.requireNonNull(mapper);
    ...
    @Override
    public final DoubleStream<X> flatMap(DoubleFunction<? extends DoubleStream> mapper) {
        Objects.requireNonNull(mapper);
        return new StatelessOp<>(this, StreamShape.DOUBLE_VALUE,
    ...
    @Override
    public final DoubleStream<X> mapMulti(DoubleMapMultiConsumer mapper) {
        Objects.requireNonNull(mapper);
        return new StatelessOp<>(this, StreamShape.DOUBLE_VALUE,
                StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT | StreamOpFlag.NOT_SIZED) {
    ...
    @Override
    public DoubleStream<X> unordered() {
        if (!isOrdered())
            return this;
    ...
    @Override
    public final DoubleStream<X> filter(DoublePredicate predicate) {
    ...
    @Override
    public final DoubleStream<X> peek(DoubleConsumer action) {
    ...
    @Override
    public final DoubleStream<X> limit(long maxSize) {
        if (maxSize < 0)
    ...
    @Override
    public final DoubleStream<X> skip(long n) {
        if (n < 0)
    ...
    @Override
    public final DoubleStream<X> takeWhile(DoublePredicate predicate) {
        return WhileOps.makeTakeWhileDouble(this, predicate);
    }

    @Override
    public final DoubleStream<X> dropWhile(DoublePredicate predicate) {
        return WhileOps.makeDropWhileDouble(this, predicate);
    }

    @Override
    public final DoubleStream<X> sorted() {
        return SortedOps.makeDouble(this);
    }

    @Override
    public final DoubleStream<X> distinct() {
    ...
    @Override
    public void forEach(DoubleConsumer consumer)  throws X {
        evaluate(ForEachOps.makeDouble(consumer, false));
    }

    @Override
    public void forEachOrdered(DoubleConsumer consumer) throws X {
        evaluate(ForEachOps.makeDouble(consumer, true));
    }

    @Override
    public final double sum() throws X {
        /*
    ...
    @Override
    public final OptionalDouble min() throws X {
        return reduce(Math::min);
    }

    @Override
    public final OptionalDouble max() throws X {
    ...
    @Override
    public final DoubleSummaryStatistics summaryStatistics() throws X {
        return collect(DoubleSummaryStatistics::new, DoubleSummaryStatistics::accept,
                       DoubleSummaryStatistics::combine);
    }

    @Override
    public final double reduce(double identity, DoubleBinaryOperator op) throws X {
        return evaluate(ReduceOps.makeDouble(identity, op));
    }

    @Override
    public final OptionalDouble reduce(DoubleBinaryOperator op) throws X {
    ...
    @Override
    public final boolean anyMatch(DoublePredicate predicate) throws X {
        return evaluate(MatchOps.makeDouble(predicate, MatchOps.MatchKind.ANY));
    }

    @Override
    public final boolean allMatch(DoublePredicate predicate) throws X {
        return evaluate(MatchOps.makeDouble(predicate, MatchOps.MatchKind.ALL));
    }

    @Override
    public final boolean noneMatch(DoublePredicate predicate) throws X {
        return evaluate(MatchOps.makeDouble(predicate, MatchOps.MatchKind.NONE));
    }

    @Override
    public final OptionalDouble findFirst()  throws X {
        return evaluate(FindOps.makeDouble(true));
    }

    @Override
    public final OptionalDouble findAny() throws X {
        return evaluate(FindOps.makeDouble(false));
    }

    @Override
    public final double[] toArray() throws X {
     ...
     * @param <E_IN> type of elements in the upstream source
     */
    static class Head<E_IN, throws X> extends DoublePipeline<E_IN, X> {
        /**
         ...
         */
        Head(Supplier<? extends Spliterator<Double, X>> source,
             int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
        }
         ...
         * @param parallel {@code true} if the pipeline is parallel
         */
        Head(Spliterator<Double, X> source,
             int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
        }
    ...
    abstract static class StatefulOp<E_IN, throws X>
        ...
        @Override
        abstract <P_IN> Node<Double> opEvaluateParallel(PipelineHelper<Double, X> helper,
                                                        Spliterator<P_IN, X> spliterator,
