 ...
 * @since 1.8
 */
abstract class PipelineHelper<P_OUT, throws X> {
     ...
     */
    abstract <P_IN, S extends Sink<P_OUT>>
     ...
     */
    abstract<P_IN>
    Spliterator<P_OUT, X> wrapSpliterator(Spliterator<P_IN, X> spliterator);
     ...
     */
    abstract <P_IN> Node<P_OUT> evaluate(Spliterator<P_IN, X> spliterator,
                                         boolean flatten,
                                         IntFunction<P_OUT[]> generator) throws X;
}
